...
static void task(void* parameter) noexcept
{
    ...
    Utility::SPIDevice spi_device{max31865_spi_device, max31865_chip_select};

    using MAX31865 = MAX31865::MAX31865;
    MAX31865 max31865{std::move(spi_device),
                      0.0F,
                      180.0F,
                      MAX31865::NWires::TWO,
                      MAX31865::FaultDetect::NO_ACTION,
                      MAX31865::FaultClear::AUTO,
                      MAX31865::Filter::HZ50,
                      MAX31865::ConvMode::ONESHOT};
